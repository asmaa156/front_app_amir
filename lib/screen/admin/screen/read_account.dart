...
class _ReadAccountState extends State<ReadAccount> {
  ...
  void _sortNew(String ascending) {
    ...
    setState(() {
      results = users
          .where((user) => user.role.toLowerCase().contains(ascending))
          .toList();
      log(results.map((e) => e.role).toString());
      setState(() {
        _foundInfo = results;
      });
    });
  ...
  void _runFilter(String enteredKeyword) {
    ...
    if (enteredKeyword.isEmpty) {
      ...
      results = users
          ...
          .toList();
      log(results.map((e) => e.firstName).toString());
      setState(() {
        _foundInfo = results;
      });
    }
                ...
                child: Column(children: [
                  ...
                  Expanded(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      UsersModel? item = _foundInfo[index];
                      return ListTile(
                        ...
                        trailing: Row(
                          ...
                          children: [
                            ...
                            IconButton(
                                onPressed: () {
                                  userController.deleteUser(item.id);
                                  setState(() {
